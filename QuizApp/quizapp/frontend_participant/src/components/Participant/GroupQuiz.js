...
class GroupQuiz extends Component {
...
export default connect(mapStateToProps, { activeUser, startQuestion, navQuestion, answerSubmit, activeQuestion })(GroupQuiz);